...
![Screenshot](attachment/50_资源/Screenshot.png)
...
cd my-vault
git sparse-checkout set attachment/CN
mv attachment/CN/* attachment/CN/.* . 2>/dev/null; rmdir attachment/CN
```

**方式二：使用 degit**（无 git 历史，更简单）

```bash
npx degit MarsWang42/OrbitOS/attachment/CN my-vault
```
...
https://github.com/MarsWang42/OrbitOS/tree/main